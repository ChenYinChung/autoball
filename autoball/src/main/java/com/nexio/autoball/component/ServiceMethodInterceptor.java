...
/**
 * 紀錄每個Service method 處理花費時長
 */
@Aspect
@Component
public class ServiceMethodInterceptor {

    private static Logger logger = LoggerFactory.getLogger(ServiceMethodInterceptor.class);

    @Around("execution(* com.nexio.autoball.service..*.*(..))")
